      ...
      <img src={props.img} alt="img" className='h-30 w-30' />
        <div className="flex flex-col justify-between">
            ...
            <div class="flex py-3 items-center">
              <button onClick={() => PlusBtn(props.id)} className="group dark:text-white rounded-r-xl px-1 py-[10px] border border-gray-200 flex items-center justify-center shadow-sm shadow-transparent transition-all duration-500 hover:bg-gray-50 hover:border-gray-300 hover:shadow-gray-300 focus-within:outline-gray-300">
              ...
              <button onClick={() => MinusBtn(props.id)} disabled={props.count <= 1} className="group rounded-l-xl px-1 py-[10px] border border-gray-200 flex items-center justify-center shadow-sm shadow-transparent transition-all duration-500 hover:bg-gray-50 hover:border-gray-300 hover:shadow-gray-300 focus-within:outline-gray-300">
                  <svg class="stroke-gray-900 transition-all duration-500 group-hover:stroke-black" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 22 22" fill="none">
              ...
              <button onClick={() => deleteItem(props.id)} className='mr-2'>
