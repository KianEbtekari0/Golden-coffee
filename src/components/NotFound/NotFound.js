  ...
  return (
    ...
    <Header />
        <div className='h-[100vh] flex flex-col items-center justify-between'>
            <section class="my-[100px] md:my-[200px] lg:my-[250px]">
                <div class="">
                    <div class="text-center px-2">
                        <h1 class="mb-4 text-2xl md:text-3xl lg:text-4xl tracking-tight font-DanaDemiBold dark:text-white">صفحه ای که دنبال آن بودید پیدا نشد!</h1>
                        <Link to='/' class="inline-flex items-center justify-center gap-1.5 text-orange-300 font-DanaMedium text-base md:text-lg px-5 py-2.5 text-center dark:focus:ring-primary-900 my-4">
                        صفحه اصلی
