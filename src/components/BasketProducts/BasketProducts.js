      ...
      <img src={props.img} alt="img" className='h-30 w-30' />
        <div className="flex flex-col justify-between">
            ...
            <div class="flex py-3 items-center">
              <button
                  class="group dark:text-white rounded-r-xl px-1 py-[10px] border border-gray-200 flex items-center justify-center shadow-sm shadow-transparent transition-all duration-500 hover:bg-gray-50 hover:border-gray-300 hover:shadow-gray-300 focus-within:outline-gray-300">
              ...
              <button class="group rounded-l-xl px-1 py-[10px] border border-gray-200 flex items-center justify-center shadow-sm shadow-transparent transition-all duration-500 hover:bg-gray-50 hover:border-gray-300 hover:shadow-gray-300 focus-within:outline-gray-300">
