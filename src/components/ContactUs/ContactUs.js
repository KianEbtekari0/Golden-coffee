      ...
      <section className='mb-8 px-4 md:px-0 md:mb-20'>
        <div className='container'>
            <div className='flex items-center justify-center gap-x-5 lg:gap-x-20'>
                ...
                <div>
                    <h1 className='font-MorabbaMedium text-2xl sm:text-3xl lg:text-5xl'>یکی از بهترین قهوه ها!</h1>
                    <p className='font-MorabbaLight mt-0.5 lg:mt-2.5 text-base sm:text-xl lg:text-2xl'>کیفیت قهوه را از ما بخواهید...</p>
                    <span>...</span>
                    <p className='text-xs sm:text-base lg:text-lg lg:max-w-[700px]'>فضای گرم و دنج ما را احساس کنید. جایی که همه میتوانید قهوه پیدا کنید و دسر های خوشمزه ما را که کاملا با قهوه داغ همراه شده است امتحان کنید. فضای داخلی شیک و کارکنان خوش برخورد ما روز شما را میسازد!</p>
