        ...
        <div className='container'>
          <div className="flex px-10 justify-between mb-5 md:mb-12">
              ...
              <div className="flex items-center gap-2 mt-auto text-orange-300">
                  <p className='font-DanaMedium hidden xs:block xs:text-xs sm:text-base'>مشاهده همه محصولات</p>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5 hidden xs:block">
